...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "Readme.md", "changelog.txt", "data/login.netrc", "data/newlineless.netrc", "data/password.netrc", "data/permissive.netrc", "data/sample.netrc", "lib/netrc.rb", "test/test_lex.rb", "test/test_netrc.rb", "test/test_parse.rb"]
